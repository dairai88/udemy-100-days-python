...
def next_card():
    """next card"""
    global current_card   # pylint: disable=global-statement
    global flip_timer     # pylint: disable=global-statement
    window.after_cancel(flip_timer) # pylint: disable=used-before-assignment
